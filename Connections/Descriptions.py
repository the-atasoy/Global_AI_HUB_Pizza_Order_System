# This .py file returns descriptions of the products from database which is in folder "Data" in order to use them when creating objects.
# Thus, product's descriptions will change automatically in GUI if descriptions are changed in database.
